 ...
 *  Webエンジニアなど、プログラミングはやったことのある方（ハードウェアは初心者）
 ...
 なるべくわかりやすく書くようにしていますが、コードの全ては紹介しないのであらかじめご了承ください（Web上から取得することができます）。
...
ハードウェアの基礎はわかる、あまり時間がない、という方は、IoT体験編を試してみると実際Nefryでどんなことができるのか分かると思います。
...
Nefry BTには2つのリビジョンが存在します。（2018年4月現在）

 * Nefry BT（無印/R1）
 * Nefry BT R2

Nefry BT（無印）からNefry BT R2への変更点を説明します。
